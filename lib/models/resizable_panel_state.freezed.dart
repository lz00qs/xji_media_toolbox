...
part of 'resizable_panel_state.dart';
...
mixin _$ResizablePanelState {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, leftPanelWidth, topLeftHeight);

  @override
  String toString() {
    return 'ResizablePanelState(leftPanelWidth: $leftPanelWidth, topLeftHeight: $topLeftHeight)';
  }
}
...
abstract mixin class $ResizablePanelStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({double leftPanelWidth, double topLeftHeight});
}
...
extension ResizablePanelStatePatterns on ResizablePanelState {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(double leftPanelWidth, double topLeftHeight)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
...
class _ResizablePanelState implements ResizablePanelState {
  const _ResizablePanelState(
      {required this.leftPanelWidth, required this.topLeftHeight});
