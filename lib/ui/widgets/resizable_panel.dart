...
abstract class ResizablePanelState with _$ResizablePanelState {
  const factory ResizablePanelState({
    ...
    required bool draggingX,
    required bool draggingY,
  }) = _ResizablePanelState;
}

@riverpod
class _ResizablePanelNotifier extends _$ResizablePanelNotifier {
  @override
  ResizablePanelState build() => ResizablePanelState(
        leftPanelWidth: _leftPanelMinWidth,
        topLeftHeight: 400,
        draggingX: false,
        draggingY: false,
      );
  ...
  void setDraggingX(bool dragging) {
    state = state.copyWith(draggingX: dragging);
  }

  void setDraggingY(bool dragging) {
    state = state.copyWith(draggingY: dragging);
  }
}
...
class ResizablePanel extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final panelState = ref.watch(_resizablePanelProvider);
    final panelNotifier = ref.read(_resizablePanelProvider.notifier);
                      ...
                      children: [
                        ...
                        MouseRegion(
                          ...
                          onEnter: (_) {
                            ...
                            // true;
                            panelNotifier.setDraggingY(true);
                          },
                          onExit: (_) {
                            // draggingY.value = false;
                            // ref.read(_draggingYProvider.notifier).draggingY =
                            // false;
                            panelNotifier.setDraggingY(false);
                          },
                          child: GestureDetector(
                            ...
                            child: _DragIdentifier(
                                ...
                                highlight: panelState.draggingY),
                          ),
                        ),
                        Expanded(
                    ...
                    child: MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        child: _DragIdentifier(
                            ...
                            highlight: panelState.draggingX),
                      ),
                    ),
                  ),
